...
comportamento em um mundo de tempo continuo, nosso sistema é digital e com isso precisamos de uma
representação discreta para esta mesma função (\ref{eq:motor_pos_tf_disc}).

\begin{equation}
G(q)=\frac{\frac{k1}{JL}}{q(q+\frac{fL+k1 k2}{JL})}
...
sobre o motor. Para tanto foi considerado que a dinamica da parte mecânica do sistema é muito mais
