...
\subsection{Modelagem e considerações}
%===============================================================================

Com este sistema de equações de estado (\ref{eq:motor_eq_estados}), é possível obter-se as funções de transferências,
...
Devido a dinâmica do sistema mecânico ser muito mais lenta que a dinâmica do sistema elétrico, 
...
A equação (\ref{eq:motor_pos_tf}) representa o comportamento da posição angular do motor
...
predominante que a dinâmica da parte elétrica, podendo esta ser desconsiderada
