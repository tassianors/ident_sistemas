...
TODO: colocar os valores médios obtidos para os parametros.

\subsubsection{Resultados para um modelo incompleto}
%===============================================================================

Nesta secão será apresentado resultados para uma estimativa utilizando um modelo que não consegue
descrever o sistema própriamente. Serão utilizados os mesmos dados da estimativa do item anterior.

O modelo utilzado é descrito em (\ref{eq:mmq_motor_arx_inc}). Observa-se que o integrador não esta presente
