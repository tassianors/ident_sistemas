...
Obtém-se desta forma valore defasados dos que foram obtidos com as outras entradas
...
quando se considera o sistema com o controlador do tipo PID (\ref{fig:sys_pid}).
...
no método dos minimos quadrados é:
...
daonde o método dos mínimos quadrados fica:
...
No apendice (\ref{appendix_mmq_pid}) é apresentado o script utilizado para efetuar o
processo de estimativa dos parametros.

Na figura (\ref{fig:in_pid_quad}) pode ser observado a entrada do sistema $r(t)$ e a saída 
$y(t)$. Este conjunto de dados proporcionou o seguionte resultado para a estimativa 
dos parametros do sistema (\ref{fig:mmq_pid_data9}).

\begin{figure}[htbp]
	\center
	\includegraphics[width=0.98\columnwidth]{figures/input_data9_pid_quad.eps}
	\caption{Entrada aplicada sobre o sistema e a respctiva saída, quando considerado o
...
\begin{figure}[htbp]
	...
	\caption{Estimativa obtida para os parametros a e b considerando-se o controlador PID e aplicando-se
